...
// Sample pixel data
const pixelData = [
    { x: 5, y: 1, owner: 'Alice', contact: '100$', img: 'https://ibb.co/ZXmXsk1', amountSpent: 100 },
...
function buyPixel() {
    ...
    const x = selectedPixel.style.gridColumnStart;
    const y = selectedPixel.style.gridRowStart;
